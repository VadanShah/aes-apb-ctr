...
addRoundKey addrk1 (in,states[0],fullkeys[((128*(Nr+1))-1)-:128]);  //this is round 0 (initial AddRoundKey)

genvar i;
generate
	
	for(i=1; i<Nr ;i=i+1)begin : loop //round 1 to Nr-1
		encryptRound er(states[i-1],fullkeys[(((128*(Nr+1))-1)-128*i)-:128],states[i]);
		
		end  //now final round without MixColumns
